            ...
            <div class="card">
                ...
                <div class="card-body overflow-auto">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <label for="noktp" class="col-md-4 col-form-label text-md-end">{{ __('No. KTP') }}</label>
                            <div class="col-md-6 d-flex align-items-center">
                                <input id="noktp" type="number" class="form-control" name="noktp" required >
                            </div>
                        </div>
                        <div class="row">
                            <label for="filektp" class="col-md-4 col-form-label text-md-end">{{ __('File KTP') }}</label>
                            <div class="col-md-6 d-flex align-items-center">
                                <input id="filektp" type="file" class="form-control" name="filektp" required >
                            </div>
                        </div>                        
                        <div class="row">
